...
import com.community.batch.jobs.InactiveUserPartitionJobConfig;
...
@SpringBootTest(classes = { BatchApplication.class, InactiveUserPartitionJobConfig.class} )
public class InactiveUserPartitionJobTest {
